...
<Box style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', border: '1px solid #ccc',marginTop:'25px', padding: '10px', borderRadius: '8px' }}>
  ...
  <Box style={{ position: 'fixed', top: 0, right: 0, maxWidth: '90%',backgroundColor:'#80000080',paddingLeft:'40px', padding: '10px', boxSizing: 'border-box', zIndex: 1, display: 'flex', alignItems: 'center', border: '1px solid #ccc' }}>
    <input
      type="text"
    ...
    />
    <Button variant="contained" sx={{ height: '40px',backgroundColor:'#C00100', minWidth: '80px', marginRight: '280px', }}>Search</Button>
