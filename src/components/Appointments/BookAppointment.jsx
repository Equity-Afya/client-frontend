...
import { Button, TextField, Typography, Container, Grid, FormControl, InputLabel, Select, MenuItem, Snackbar } from '@mui/material';
      ...
      <Grid container justifyContent="center">
        <Grid item xs={12} sm={8} md={6}>
          <div style={styles.formContainer}>
            ...
            {successMessage && (
              <Typography variant="body1" align="center" style={styles.successMessage}>
                {successMessage}
              </Typography>
            )}
            {errorMessage && (
